...
call_user_func(function($extensionKey)
{
    ...
    for ($i = 1; $i <= 5; $i++) {
        $GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['cms/layout/class.tx_cms_layout.php']['list_type_Info']['imagecycle_pi' . $i][$extensionKey] = \Typo3Extension\Imagecycle\Hooks\CmsLayout::class . '->getExtensionSummary';

        \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addPItoST43($extensionKey, 'pi' . $i . '/class.tx_imagecycle_pi' . $i . '.php', '_pi' . $i, 'list_type', 1);
    }
